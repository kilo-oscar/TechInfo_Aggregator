...
def build_query_groups() -> list[tuple[str, list[str]]]:
    return [
        ...
        ("Google News / Robotics Sensing", [
            '("視覚センシング" OR "マシンビジョン" OR "ロボットビジョン" OR "画像認識") ロボット',
            '("machine vision" OR "visual sensing" OR "robot vision") robotics',
            '("聴覚センシング" OR "音響センシング" OR "音源定位" OR "ロボット聴覚") ロボット',
            '("auditory sensing" OR "audio perception" OR "robot hearing" OR "sound source localization") robotics',
            '("触覚センシング" OR "触覚センサ" OR "触覚センサー" OR "触覚認識") ロボット',
            '("tactile sensing" OR "tactile sensor" OR "tactile perception") robotics',
            '("力触覚" OR "力覚センサ" OR "力トルクセンサ" OR "6軸力覚") ロボット',
            '("force tactile" OR "force-torque sensor" OR "force sensing") robotics',
        ]),
        ("Google News / Robotics Components", [
            '("ロボットセンサ" OR "ロボット センサ" OR "センサー") ロボット (開発 OR 新製品 OR 発表)',
            '("robot sensor" OR "robotics sensor") (development OR launch OR release)',
            '("アクチュエータ" OR actuator) ロボット (開発 OR 新製品 OR 発表)',
            '("robot actuator" OR "robotics actuator") (development OR launch OR release)',
            '("ギヤ" OR "減速機" OR "精密減速機" OR "ハーモニックドライブ") ロボット',
            '("robot gear" OR "robot gearbox" OR "robot reducer" OR "harmonic drive") robotics',
            '("ダイレクトドライブモータ" OR "DDモータ" OR "トルクモータ") ロボット',
            '("direct drive motor" OR "torque motor") robotics',
        ]),
